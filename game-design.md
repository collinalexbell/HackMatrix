# HackMatrix
## How to build a window manager, the game
Hi, this is my Hack Matrix
It is a 3d window manager
... but it is also a game engine

...and I'm kickstarting an RPG game that will teach you
how to build your own 3d window manager game engine

as far as I know, this will be the first 3d game experience
that allows you to use your favorite coding IDE inside of the game world

each mission in this RPG game will teach you, step by step,
how to build your own Hack Matrix
so that you can bring your own apps into a desktop world of your own making

This is an interactive and immersive tutorial series..
..and like most tutorials, it can be as handholdy or as handsoff as you would like


So whether you just getting into programming, you are an intermediate programmer who has never touched C++, or you are a veteran graphics programmer... you can build
your own window manager... just follow the wisdom of the greybeards in this
RPG experience.
