/*
    ...
    GLX loader generated by glad 0.1.34 on Sun Sep 17 23:08:35 2023.
    ...
    Commandline:
        --api="glx=1.4" --generator="c" --spec="glx" --extensions="GLX_EXT_texture_from_pixmap"
    Online:
        https://glad.dav1d.de/#language=c&specification=glx&loader=on&api=glx%3D1.4&extensions=GLX_EXT_texture_from_pixmap
*/
