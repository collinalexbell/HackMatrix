...
void
EntityRegistry::save(entt::entity e)
{
  for (auto persister : persisters) {
    persister->save(e);
  }
...
void
EntityRegistry::load(entt::entity e)
{
  // this is useless
  for (auto persister : persisters) {
    persister->load(e);
...
void
EntityRegistry::addPersister(std::shared_ptr<SQLPersister> p)
{
...
void
EntityRegistry::depersist(entt::entity entity)
{
...
EntityRegistry::locateEntity(int entityIdForDB)
{
