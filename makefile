...
INCLUDES        = -Iinclude -I/usr/local/include -Iinclude/imgui -Itracy/public
...
build/wayland/pointer.o: src/wayland/pointer.cpp include/wayland/pointer.h include/wayland/wlr_compositor.h include/engine.h include/wayland_app.h
	mkdir -p build/wayland
	g++ -std=c++20 $(FLAGS) $(INCLUDES) $(WLROOTS_CFLAGS) -o build/wayland/pointer.o -c src/wayland/pointer.cpp

build/wayland/keyboard.o: src/wayland/keyboard.cpp include/wayland/keyboard.h include/wayland/wlr_compositor.h include/engine.h include/wayland_app.h
	mkdir -p build/wayland
	g++ -std=c++20 $(FLAGS) $(INCLUDES) $(WLROOTS_CFLAGS) -o build/wayland/keyboard.o -c src/wayland/keyboard.cpp
...
build/systems/Player.o: src/systems/Player.cpp include/systems/Player.h include/entity.h include/model.h
	g++ -std=c++20 $(FLAGS) -o build/systems/Player.o -c src/systems/Player.cpp $(INCLUDES)
